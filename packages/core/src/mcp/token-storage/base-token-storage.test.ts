...
describe('BaseTokenStorage', () => {
  ...
  describe('validateCredentials', () => {
    ...
    it.each([
      ...
      expect(() => storage.validateCredentials(credentials as OAuthCredentials)).toThrow(expectedError);
    });
  });
  ...
  describe('sanitizeServerName', () => {
    it.each([
      ...
      ['invalid characters with underscore replacement', 'test@server#example', 'test_server_example'],
