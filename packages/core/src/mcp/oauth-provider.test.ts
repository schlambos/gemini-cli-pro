...
import type { MCPOAuthConfig, OAuthTokenResponse, OAuthClientRegistrationResponse } from './oauth-provider.js';
...
describe('MCPOAuthProvider', () => {
  ...
  describe('authenticate', () => {
    ...
    it('should handle refresh token failure with non-json response', async () => {
      ...
      const authProvider = new MCPOAuthProvider();
      await expect(
        authProvider.refreshAccessToken(mockConfig, 'invalid_refresh_token', 'https://auth.example.com/token')
