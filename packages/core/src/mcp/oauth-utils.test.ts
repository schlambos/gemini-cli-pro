...
import type { OAuthAuthorizationServerMetadata, OAuthProtectedResourceMetadata } from './oauth-utils.js';
...
describe('OAuthUtils', () => {
  ...
  describe('discoverOAuthConfig', () => {
    ...
    it('should throw error when resource metadata does not match server URL', async () => {
      ...
      await expect(OAuthUtils.discoverOAuthConfig('https://example.com/mcp')).rejects.toThrow(
