...
describe('memoryImportProcessor', () => {
  ...
  describe('processImports', () => {
    ...
    it('should ignore imports inside code blocks', async () => {
      ...
      mockedFs.access.mockResolvedValue(undefined);
      mockedFs.readFile.mockResolvedValueOnce(importedContent1).mockResolvedValueOnce(importedContent2);
  ...
  describe('validateImportPath', () => {
    it('should reject URLs', () => {
      ...
      expect(validateImportPath('https://example.com/file.md', basePath, [allowedPath])).toBe(false);
