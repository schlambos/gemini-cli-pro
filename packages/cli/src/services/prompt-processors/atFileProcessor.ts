...
import { AT_FILE_INJECTION_TRIGGER, type IPromptProcessor, type PromptPipelineContent } from './types.js';
import { extractInjections } from './injectionParser.js';

export class AtFileProcessor implements IPromptProcessor {
  constructor(private readonly commandName?: string) {}

  async process(input: PromptPipelineContent, context: CommandContext): Promise<PromptPipelineContent> {
