...
import { detectIdeFromEnv, IDE_DEFINITIONS, type IdeInfo } from '@google/gemini-cli-core/src/ide/detect-ide.js';
...
async function checkForUpdates(
  ...
  try {
    ...
    if (!isManagedExtensionSurface && latestVersion && semver.gt(latestVersion, currentVersion)) {
